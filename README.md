...
the old firmware used for lake is here, new firmware is in https://github.com/rhgndf/hfsdr

Steps to using

1. Connect & Pair a device. Make sure your browser supports WebUSB
2. Wait a while (up to 30s) for the device to startup
